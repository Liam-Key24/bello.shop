  ...
  return (
    <div className="flex flex-wrap gap-4 p-4">
      ...
      <div className="w-[425px] h-[450px] bg-gray-200 rounded-lg relative hover:scale-105 transition-all duration-300 ease-in-out shadow-md hover:shadow-xl">
        ...
        />
        <div className='bg-green-100 text-green-300 absolute bottom-4 right-4 p-2 rounded-lg shadow-md'> 
          <p>@lydia-is-beauty</p>
        </div>
      </div>
      ...
      <div className="w-[360-px] md:w-[300px] h-[450px] bg-green-100 text-green-300 rounded-lg flex flex-col justify-between p-4">
